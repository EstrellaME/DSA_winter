...
class Inventario:
    ...
    def agregar_producto(self,codigo,precio):
       #si no existe el codigo lo agrega
    ...
    def consultar_precio(self,codigo): 
        #saber si el producto existe en el diccionario 
        if codigo in self.productos:
            print(f"{codigo} ${self.productos[codigo]}")
        
            
inventario=Inventario()
inventario.agregar_producto("coca", 19.99)
inventario.agregar_producto("chet", 29.99)
inventario.mostrar_productos()
inventario.consultar_precio("coca")
inventario.consultar_precio("C003")
